                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <?php $i=1; foreach($users as $row):?>
                        ...
                        <!--   <a href="<?php echo base_url("index.php/Ip_admin/Edit_admin/$row->id");?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a> -->

                            <a href="<?php echo base_url("index.php/Ip_admin/customer_Delete/$row->id");?>" onClick="return doconfirm();" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>

                         <!--  <a href="<?php echo base_url("index.php/Ip_admin/admin_varify/$row->id");?>" class="btn btn-primary btn-xs"><i class="fa fa-play"></i> strat </a>

                           <a href="<?php echo base_url("index.php/Ip_admin/admin_Reject/$row->id");?>" class="btn btn-danger btn-xs"><i class="fa fa-stop"></i> stop </a> -->
