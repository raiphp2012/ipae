          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 style="color:#1e91cf;">ALL ADMIN DETAILS</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Admin Details<small style="color:#1e91cf;">Admin Details</small></h2>
                    <ul class="nav navbar-right panel_toolbox">

                    <li><a href="<?php echo base_url("index.php/welcome/registration");?>"><i style="color:#1e91cf;";" class="fa fa-plus-square fa-2x"></i></a>
                      </li>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th style="color:#1e91cf;">Admin-Name</th>
                          <th style="color:#1e91cf;">Email</th>
                      ...
                      <tbody>
                      <?php $i=1; foreach($admin_list as $row):?>
                        <tr>
                          <td><?php echo $i++;?></td>
                          ...
                          <td style="width:50px;">
                          <!-- <a href="<?php echo base_url("ip_admin/Admin_Delete/$row->id");?>" onClick="return doconfirm();"><i style="color:red;" class="fa fa-trash-o fa-lg"></i></a>
                          <a href="<?php echo base_url("ip_admin/Edit_admin/$row->id");?>"><i style="color:blue;" class="fa fa-pencil-square-o fa-lg"></i></a> -->



                          <a href="<?php echo base_url("ip_admin/Edit_admin/$row->id");?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>

                            <a href="<?php echo base_url("ip_admin/Admin_Delete/$row->id");?>" onClick="return doconfirm();" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
