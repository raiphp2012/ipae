...
class CI_Cart {
	...
	var $id_rules	= '\.a-z0-9_-'; // alpha-numeric, dashes, underscores, or periods
	var $product_name_rules	= '[:print:]'; // alpha-numeric, dashes, underscores, colons or periods
	...
	function _insert($items = array())
	{
		...
		// Note: These can be user-specified by setting the $this->id_rules variable.
		if ( ! preg_match("/^[".$this->id_rules."]+$/i", $items['id']))
		{
