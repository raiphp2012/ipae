...
<tr>
<td align="center"><br><br><strong  style="font-family: Verdana; font-size: 14px; color: #4d4d4d;">THANK YOU FOR VERIFYING YOUR ACCOUNT ON WWW.IP-AE.COM.</strong></td>
</tr>
<tr>
<td height="15"  style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #f1f1f1; width: 100%;"> <br><br></td>
</tr>
...
<TABLE><TR><TD>LOGIN ID</TD><TD> :</TD><TD><?php echo $username;?></TD></TR>
 <TR><TD>PASSWORD </TD><TD>:</TD><TD>****** (YOUR CHOOSEN)</TD></TR>
...
<tr>
<td ALIGN="CENTER"  style="font-family: Verdana; font-size: 12px; color: #4d4d4d;"><BR><BR>PLEASE <a href="<?php echo $login_url;?>" style="color:#fff; background-color:#000;	 text-decoration:none; margin:10px; padding:10px;">CLICK HERE</a> FOR LOGIN YOUR ACCOUNT. <br><br></td>
