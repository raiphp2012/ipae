...
<tr>
<td style="font-family: Verdana; font-size: 12px; color: #4d4d4d;">Hello <?php echo $name;?>,</td>
</tr>
<tr>
...
<tr>
<td ALIGN="CENTER" style="font-family: Verdana; font-size: 12px; color: #4d4d4d;"><br><br>


<TABLE>

<TR><TD>Name</TD><TD> :</TD><TD><?php echo $name;?></TD></TR>
 <TR><TD>Email Id</TD><TD>:</TD><TD><?php echo $email;?></TD></TR>
 <TR><TD>Contact Number</TD><TD> :</TD><TD><?php echo $contact;?></TD></TR>
 <TR><TD>Message </TD><TD>:</TD><TD><?php echo $subject." ".$message?></TD></TR>
 <?php if(!empty($attachment)){

 	?>
 <TR><TD>attachment</TD><TD> :</TD><TD><a href="<?php echo $attachment;?>">attachmnet</a> </TD></TR>
 <?php } ?>
...
<tr>
<td ALIGN="CENTER"  style="font-family: Verdana; font-size: 12px; color: #4d4d4d;"><BR><BR>PLEASE <a href="<?php echo $login_url;?>" style="color:#fff; background-color:#000;	 text-decoration:none; margin:10px; padding:10px;">CLICK HERE</a> FOR LOGIN YOUR ACCOUNT.</td>
</tr>
<tr>
<td height="15" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #f1f1f1; width: 100%;"> </td>
</tr>

<TR><td style="font-family: Verdana; font-size: 12px; color: #4d4d4d;"><br><br>We at iP-ae.com are professionals with experience in Smart Phone and e-commerce industries, more importantly we are aware consumers like you who have gathered all the good and bad experiences in procuring iPhones for six straight years. This is our attempt to distill all the good experiences and bring a smile to your face when you buy one.
</TR>
<tr>
  ...
  <tbody><tr style="background:url(http://www.ip-ae.com/assests/img/footer.jpg) no-repeat 0;">
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="53%" align="center" style="font-family: Verdana; font-size: 12px; color: #4d4d4d;"><strong>Office No. 303, Ali Rashid Alabbar Al Marar, Deira, P.O. Box: 1272,
		Dubai-United Arab Emirates<br>
		Email: info@ip-ae.com <br>
		Contact: (+971)-5-6545 5670<br>
		www.ip-ae.com</strong></td>
        </tr>
      <tr>
