...
<tr>
<td align="center"><br><br><strong  style="font-family: Verdana; font-size: 14px; color: #4d4d4d;">Thank you for signing up with http://www.ip-ae.com</strong></td>
</tr>
<tr>
<td height="15"  style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #f1f1f1; width: 100%;"> <br><br></td>
</tr>
...
<td  align="center"><br><br>
 Please verify your account by clicking on the below link.<br><br><a href="<?php echo $url_veri_code;?>" style="color:#fff; background-color:#000;  text-decoration:none; margin:10px; padding:10px;">CLICK HERE</a>
</td>
</tr>
