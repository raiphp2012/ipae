function validateform(){
  ...
  function validateregister()
  {
    ...
    var dotpos = email.lastIndexOf(".");
     ...
     if(name == '' || name == null){
      document.getElementById('error_usr2').innerHTML = '*Full Name is required';
       
    }
    else if(!isNaN(name)){
       document.getElementById('error_usr2').innerHTML = '*Full Name must not contain numeric value';
    ...
    if(email == '' || email == null){
       document.getElementById('error_email2').innerHTML = '*Email is required';
       
    }
    else if(atpos<1 || dotpos<atpos+2 || dotpos+2>=email.length){
       document.getElementById('error_email2').innerHTML = '*Email invalid';
    }
else if(email.length > 50){
       document.getElementById('error_email2').innerHTML = '*Email must not be greater than 50 characters';
    }
    else{
