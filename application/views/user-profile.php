...
<form class="form-horizontal" onsubmit="return profileValidate222()" method="post" action="<?php echo base_url();?>welcome/userUpdate" enctype="multipart/form-data">                           
  ...
  <div class="form-group" id="labl">
    ...
    <div class="col-sm-9">
      ...
      <input name="mid_name" id="mid_name" maxlength="40" class="form-control alphaonly" value="<?php echo $userdata['0']->mid_name;?>" type="text" onKeyup="regexp(this);">
  ...
  <div class="form-group" id="labl">
    <label for="inputEmail3" class="col-sm-3 control-label" class="form-control alphaonly" >Last Name <span class="required error"> *</span></label>
    <div class="col-sm-9">
      <input name="last_name" id="last_name" maxlength="40" class="form-control alphaonly" value="<?php echo $userdata['0']->last_name;?>" type="text" onKeyup="regexp(this);">
...
<span class="error" id="error_gender"></span>
  ...
  <div class="form-group" id="labl">
    ...
    <div class="col-sm-9">
      <input name="mobile" type="hidden" class="form-control contact1" id="contact1" minlength="9" maxlength="9" value="<?php echo $userdata['0']->contact;?>"  type="tel"><?php echo $userdata['0']->contact;?>
...
<div class=""max-height: 600px;">          
  <table class="table table-bordered">
    ...
    <?php $order_cancel_status = $this->Ipae_model->getcancelpaymentstatus($order['order_number']);?>
            <tr>
                ...
                <td><?php  echo ltrim($order['count_orders'], '0'); ?> </td>
                <td><?php echo $order['order_date']; ?></td>
				<?php if($order_cancel_status== 1){?>
					 <td>Cancelled</td>
				<?php }else{?>
...
?>
 ...
 <td><?php if($order['order_status'] == 1 && $diff<=86400 && $order_cancel_status==0){ ?><a href='<?php echo base_url(); ?>welcome/cancelOrder/<?php echo $order['id']; ?>' onclick="return confirm('Do you want to cancel the order ?');">Cancel</a> |<?php } ?> <a href='<?php echo base_url(); ?>welcome/orderdetails/<?php echo $order['order_number']; ?>'>View</a></td>                
            </tr>
            <?php $counter++; ?>
       <?php } ?>
       <?php } ?>      
