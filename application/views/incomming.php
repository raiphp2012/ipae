...
<head>
	...
	<meta name="keywords" content="">
     ...
     <title><?php echo $title;?> - IP-AE</title>
...
if(!isset($this->session->userdata['logged_in']))
 ...
 ?>
    ...
    <div class="row" style="padding-bottom: 150px;">
        <div class="col-md-12">
            <div class="error-template" style="padding-top: 120px;">
                <h1>
                    Oops!</h1>
                <h2>
                    404 Not Found</h2>
                ...
                <div class="error-actions">
                    <a href="<?= base_url();?>" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
                        Take Me Home </a><a href="<?php echo base_url();?>Contact-Us" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span> Contact Support </a>
                </div>
            </div>
        </div>
    </div>
