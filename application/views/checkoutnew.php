      ...
      <label for="usr">Emirates:</label>
       <select name="stateid" id="state_id2" required>
                ...
                if($new_user_table){ ?>
                   ...
                   <br/>  <div class="table-responsive"><table class="table table-bordered">
                    ...
                    <?php foreach($new_user_table as $address){ ?>
                      <tr>
                        <input type="hidden" name="address" id="address" value="<?php echo $address->id; ?>" <?php echo $checked; ?>>
                                          ...
                                          <table class="table table-hover table-inverse">
                                             ...
                                             foreach($this->cart->contents() as $row):?>
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="text-right"><?php echo $row['price'];?> AED</td>
                       <?php 
                        $subtotal=$row['price']*$row['qty'];
                   $grand_total = $grand_total + $subtotal;
                    $flat_ship_rate += $row['qty'];
               ?>                             
               <td class="text-right"><?php echo $subtotal; ?> AED 
              </td>
                                                </tr>
                                             ...
                                             <tfoot>
                                              ...
                                              <tr id="shipping_rate">
                                                ...
                                                <tr id="shipping_rate2">
                                                   ...
                                                   <td class="text-right" id="flat_ship">0 AED</td>
                                                </tr>
                                               ...
                                               <!--  <tr id="delivery_rate" style="display:none;">
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="text-right" id="vat">0 AED</td>
                                                </tr>
                                                <tr>
    ...
    $("input[name='payment']").click(function(){
         ...
         //var y = $("input[name='delivery_type']:checked").val();
          if(x == 'cod'){
              ...
              $("#shipping_rate").show();
              //$("#delivery_rate").hide();
              $("#grandTotal").html("<?php echo $grand_total + $flat_ship_rate; ?> AED");
              $("#grandTotal2").html("<?php echo $grand_total + $flat_ship_rate; ?> AED");
           
          }
          else {
             
             $("#grandTotal").html("<?php echo $grand_total; ?> AED");
             $("#grandTotal2").html("<?php echo $grand_total; ?> AED");
          }
...
<script type="text/javascript">
                      $(document).ready(function(){
                        ...
                        $("#flat_ship").html("<?php echo $flat_ship_rate; ?> AED");
                        $("#grandTotal").html("<?php echo $grand_total + $flat_ship_rate; ?> AED");
                        $("#grandTotal2").html("<?php echo $grand_total + $flat_ship_rate; ?> AED");
