...
<div class="col-lg-12 text-right">
   ...
   <?php  $backLink=$this->session->userdata("backLink"); ?>
    <a  href="javascript:history.back()"><button class="btn btn-primary ">Buy</button></div></a>
	 ...
	 <div class="col-md-4 col-md-offset-1"> <img class="img-responsive"  src="<?php echo base_url();?>assests/iphonex/finish_iphone-x_dark_gray_large.jpg" >
	 <div class="finish"><p style="margin-top: 30px;">Space Gray</p></div>
	 </div>
	
	 
	 <div class="col-md-5"> <img class="img-responsive"  src="<?php echo base_url();?>assests/iphonex/finish_iphone-x_silver_large.jpg" >
	 <div class="finish"><p style="margin-top: 30px;">Silver</p>
	 </div></div>
	...
	<tr> <td>256GB</td></tr>
	 ...
	 <div class="col-md-4"> <img class=" img-responsive"  src="<?php echo base_url();?>assests/iphonex/dimensions_iphonex_large.jpeg">
	
	 </div>
	 
	 <div class="col-md-4">
	 <ul style="list-style: none;margin-top: 40px;">
	 <li style="padding: 10px;"><b>Height:</b> 143.6 mm (5.65 inches)</li>
<li style="padding: 10px;"><b>Width:</b> 70.9 mm (2.79 inches)</li>
<li style="padding: 10px;"><b>Depth:</b> 7.7 mm (0.30 inch)</li>
<li style="padding: 10px;"><b>Weight:</b> 174 grams (6.14 ounces)</li>
</ul>
	  </div>
	 ...
	 <div class="col-md-3"> <img class="sizeimg img-responsive" style="width: 147px;
height: 291px;" src="<?php echo base_url();?>assests/iphonex/display_iphone_x_large.jpg">
	</div>
	 
	 <div class="col-md-5"> 
	  <div class="finish"> 
	  <ul class="displaylist" style="margin-top: 20px">
	  <li style="padding: 5px;">Super Retina HD display</li>
	  <li style="padding: 5px;">5.8-inch (diagonal) all-screen OLED Multi-Touch display</li>
	  <li style="padding: 5px;">HDR display</li>
	  <li style="padding: 5px;">2436-by-1125-pixel resolution at 458 ppi</li>
	  <li style="padding: 5px;">1,000,000:1 contrast ratio (typical)</li>
	  <li style="padding: 5px;">True Tone display</li>
	  <li style="padding: 5px;">Wide color display (P3)</li>
	  <li style="padding: 5px;">3D Touch</li>
	  <li style="padding: 5px;">625 cd/m2 max brightness (typical)</li>
	  <li style="padding: 5px;">Fingerprint-resistant oleophobic coating</li>
	  <li style="padding: 5px;">Support for display of multiple languages and characters simultaneously</li>
	
	</div>
	 <p>The iPhone X display has rounded corners that follow a beautiful curved design, and these corners are within a standard rectangle. When measured as a standard rectangular shape, the screen is 5.85 inches diagonally (actual viewable area is less).</p>
	 </div>
	...
	<div class="row rowstyle">
	 ...
	 <div class="col-md-3 col-md-offset-1 "> <p class="rowheader">Splash, Water, and Dust Resistant<sup><small>3</small><sup></p> 
	 </div>
...
<div class="finish">
	 ...
	 <li>Wide-angle: ƒ/1.8 aperture</li>
	 <li>Telephoto: ƒ/2.4 aperture</li>
	 <li>Optical zoom; digital zoom up to 10x</li>
	 <li>Portrait mode</li>
	 ...
	 <li>Optical zoom; 6x digital zoom</li>
	 ...
	 <li>Body and face detection</li>
	 <li>Noise reduction</li>
	 <li>Take 8-MP still photos while recording 4K video</li>
	 <li>Playback zoom</li>
	...
	<div class="row rowstyle">
	 ...
	 <div class="col-md-2 col-md-offset-1"> <p class="rowheader">TrueDepth Camera</p> </div>
	 <div class="col-md-8 finish">
	 <ul class="displaylist">
	 <li>7MP camera</li>
	 <li>Portrait mode</li>
	 ...
	 <div class="col-md-2 col-md-offset-1"> <p class="rowheader">Face ID</p> </div>
	 <div class="col-md-5"><p class="finish">Enabled by TrueDepth camera for facial recognition</p> </div>
	 ...
	 <div class="col-md-2"><p class="row2header">Model A1865*</p></div>
    ...
    GSM/EDGE (850, 900, 1800, 1900 MHz)
	 ...
	 <p class="row2header">Model A1901*</p></div>
    ...
    NFC with reader mode
	 ...
	 <li>Supports Dolby Vision and HDR10 content</li>
	  <li>AirPlay Mirroring, photos, and video out to Apple TV (2nd generation or later)<span class="bigcaption"><sup>5</sup></span></li>
	   <li>Video mirroring and video out support: Up to 1080p through Lightning Digital AV Adapter and Lightning to VGA Adapter (adapters sold separately)<span class="bigcaption"><sup>5</sup></span></li>
	 ...
	 <div class="col-md-7">
	 <img class="externalbtnimg img-responsive" src="<?php echo base_url();?>assests/iphonex/specification.jpeg">
	 ...
	 <div class="col-xs-4"><p class="finish">Lasts up to 2 hours longer than iPhone 7 </p>
	 <dl class="finish">
	 ...
	 <div class="col-md-6">
	  <ul class="listfont">
	    <li>Accessibility features help people with disabilities get the most out of their new iPhone X. With built-in support for vision, hearing, physical and motor skills, and learning and literacy, you can fully enjoy the world’s most personal device.</li>
	...
	<div class="row rowstyle">
	 ...
	 <div class="col-xs-2"><img  src="<?php echo base_url();?>assests/tech_speces/Free Apps from Apple/icon_clips_large.jpg">
	 <div class="imgcaption">Music memos</div >
	 </div>
     ...
     <p class="finish">    iPhone X is not compatible with existing micro-SIM cards.</p>
     </div>
	 ...
	 <div class="col-md-4"><p class="finish">iPhone X (Model A1865, A1901): M3, T4</p></div>
	 ...
	 <p class="finish">English (Australia, Canada, India, Ireland, New Zealand, Singapore, South Africa, UK, U.S.), Spanish (Chile, Mexico, Spain, U.S.), French (Belgium, Canada, France, Switzerland), German (Austria, Germany, Switzerland), Italian (Italy, Switzerland), Japanese, Korean, Mandarin (Mainland China, Taiwan), Cantonese (Mainland China, Hong Kong, Macao), Arabic (Saudi Arabia, United Arab Emirates), Danish (Denmark), Dutch (Belgium, Netherlands), Finnish (Finland), Hebrew (Israel), Malay (Malaysia), Norwegian (Norway), Portuguese (Brazil), Russian (Russia), Swedish (Sweden), Thai (Thailand), Turkish (Turkey)</p>
	 
	 
	  <p class="finish"><strong>Dictation languages</strong></p>
	 <p class="finish">English (Australia, Canada, India, Indonesia, Ireland, Malaysia, New Zealand, Philippines, Saudi Arabia, Singapore, South Africa, United Arab Emirates, UK, U.S.), Spanish (Argentina, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Paraguay, Peru, Spain, Uruguay, U.S.), French (Belgium, Canada, France, Luxembourg, Switzerland), German (Austria, Germany, Luxembourg, Switzerland), Italian (Italy, Switzerland), Japanese, Korean, Mandarin (Mainland China, Taiwan), Cantonese (Mainland China, Hong Kong, Macao), Arabic (Kuwait, Qatar, Saudi Arabia, United Arab Emirates), Catalan, Croatian, Czech, Danish, Dutch (Belgium, Netherlands), Finnish, Greek, Hebrew, Hindi (India), Hungarian, Indonesian, Malaysian, Norwegian, Polish, Portuguese (Brazil, Portugal), Romanian, Russian, Shanghainese (Mainland China), Slovakian, Swedish, Thai, Turkish, Ukrainian, Vietnamese</p>
	 
	 <p class="finish"><strong>Definition dictionary support</strong></p>
	 <p class="finish">English, Chinese (Simplified, Traditional), Danish, Dutch, French, German, Hindi, Italian, Japanese, Korean, Norwegian, Portuguese, Russian, Spanish, Swedish, Thai, Turkish</p>
	 
	 <p class="finish"><strong>Bilingual dictionary support</strong></p>
	 <p class="finish">Chinese (Simplified), Dutch, French, German, Italian, Japanese, Korean, Portuguese, Russian, Spanish</p>
	 
	  <p class="finish"><strong>Spell check</strong></p>
	 <p class="finish">English, French, German, Italian, Spanish, Danish, Dutch, Finnish, Korean, Norwegian, Polish, Portuguese, Russian, Swedish, Turkish</p>
	 </div>
	...
	<div class="row" style="margin-top: 60px;">
	 ...
	 <img class="img-responsive" style="width:1500px;height:auto;" src="<?php echo base_url();?>assests/iphonex/box_large.jpg">
